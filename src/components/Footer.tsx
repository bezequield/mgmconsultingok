      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          <div className="md:col-span-2">
            <div className="font-anton text-3xl text-white mb-4">
            ...
            <div className="flex gap-4 mt-6">
              <a
                ...
                aria-label="Instagram MGM Consulting"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:border-mgm-yellow hover:text-mgm-yellow transition-all"
                aria-label="WhatsApp MGM Consulting"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              {[
                ["Business Intelligence & KPIs", "/servicios/business-intelligence"],
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-gray-600">
          ...
          <p className="text-center">
            Consultora Estratégica para droguerías, farmacias, clínicas y laboratorios farmacéuticos en Argentina.
          </p>
        </div>
      </div>
    </footer>
